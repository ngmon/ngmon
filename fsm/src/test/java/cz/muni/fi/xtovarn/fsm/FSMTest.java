...
public class FSMTest {
    ...
    private class StringBasedFSM<T1 extends Enum<T1>> extends AbstractFiniteStateMachineNoActions<T1, String> {

        public StringBasedFSM(T1 startState, T1[] endStates, Class<T1> statesEnumClass) {
            super(startState, endStates, statesEnumClass, true);
        }
    }
