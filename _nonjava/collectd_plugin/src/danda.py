...
def read_types_from_file():	
	...
	types_file = open('/home/danos/IdeaProjects/heimdall/collectd_plugin/types.db', 'r')
...
def init(data=None):
	global f
	f = open('/home/danos/IdeaProjects/heimdall/collectd_plugin/file.txt', 'w') # open log file
